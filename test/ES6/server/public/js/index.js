	...
	var Base = function () {
	  ...
	  */
			...
			value: function setOmit(omit) {
				...
				(0, _jquery2.default)(self.omitEl).each(function (index, item) {
	  ...
	  */
			...
			value: function changePlayNav(e) {
				...
				(0, _jquery2.default)('#zx_sm span').html(self.playList.get(self.curPlay).tip);
	  ...
	  */
			...
			value: function addCode() {
				...
				var count = self.computeCount(active, self.curPlay);
				if (count) {
	  ...
	  */
			...
			value: function addCodeItem(code, type, typeName, count) {
				...
				(0, _jquery2.default)(self.cartEl).append(tpl);
				self.getTotal();
			}
	  ...
	  */
			...
			value: function getCount() {
				...
				var count = self.computeCount(active, self.curPlay);
				var range = self.computeBonus(active, self.curPlay);
				var money = count * 2;
	  ...
	  */
			...
			value: function getRandomCode(e) {
				...
				var self = this;
				if (num === '0') {
					(0, _jquery2.default)(self.cartEl).html('');
				} else {
					for (var i = 0; i < num; i++) {
	...
	var Calculate = function () {
	  ...
	  */
			value: function computeCount(active, playName) {
				var count = 0;
				var exsit = this.playList.has(playName);
	  ...
	  */
			...
			value: function computeBonus(active, playName) {
				...
				return [min, max].map(function (item) {
					return item * self.playList.get(playName).bonus;
				});
			}
